...
namespace Serveur
{
    public class GestEmpImpl : MarshalByRefObject, IGestEmpBiblio.IEmprunteur
    {
        //********************************************* consulterovrg ****************************************************//
        ...
        //******************************************* modifierCompte ***************************************************//
        public void modifierCompte(etudiant etud)
        {
            MySqlConnection c = Conx.GetDBConnection();
            try
            {
        ...
        public void modifierCompte(enseignant ens)
        {
            MySqlConnection c = Conx.GetDBConnection();
            try
            {
